...
Start with [local_review.md](local_review.md). It requires no hosted inference service or inference credential.
...
3. Record detail: inspect normalized fields, raw source text, similar records, and deterministic summary.
